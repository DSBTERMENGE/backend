...
echo.
echo ========================================
echo   INVCTL - INICIANDO SERVIDOR DEV
echo ========================================
echo.
...
echo [3/3] Iniciando servidor InvCtl...
echo.
echo ⚡ Servidor será iniciado em: http://localhost:5001
echo ⚠️  Para parar o servidor: Ctrl+C
echo.
python server_Applications_DSB.py invctl
